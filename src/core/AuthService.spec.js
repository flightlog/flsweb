...
describe('AuthService', () => {
    ...
    it('should enable the masterdata features for club admins', () => {
        ...
        // assert
        expect(enabledFeatures.masterdata).toEqual({ persons: true, clubs: true, aircrafts: true, locations: true, users: true, flightTypes: true, memberStates: true });
    ...
    it('should enable the system features for system admins', () => {
        ...
        // assert
        expect(enabledFeatures.masterdata).toEqual({ persons: true, clubs: true, aircrafts: true, locations: true, users: false, flightTypes: false, memberStates: false });
